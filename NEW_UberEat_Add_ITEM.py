...
with open("C:/Users/Admin/PycharmProjects/UberEat BurpSuit/ADD_InGroceryUberEat.csv", "r") as csv_file:
    ...
    for lin in csv_reader:
        ...
        cookies = {
            ...
            # Importan
            'sid': 'QA.CAESEOdVxFkz8053g7jg1up40AYYsOryowYiATEqJGQwNGIwNjNkLTJlMmYtNDgyMS1hMjljLTAwZDMyYTU1M2QzMTJAoEBnj6OYUD5FxL9tzQa576iRbDsf1_osRWL7z5HOwkYS8I8AzPeCOzVxJXxlD9OfY8GE4zVh-3_GWaWVx7hf8joBMUINLnViZXJlYXRzLmNvbQ.JXlA3onth17htpFmprE-DD0GpBru8sK4kaivWVzXiKI',
        ...
        print(item_name)
        x = json.loads(response_add.text)
        print(x['status'])
        #
        # # SET Category
        # set_category_json_data = {
        #     "changes": [
        #         {
        #             'action': 'update',
        #             'type': 'item',
        ...
        #                 },
        #                 'vendorInfo': {
        #                     'externalID': 'Giovanni_Rana_Raviol_02100',
        #                     'externalData': None,
        #                     'groupUUID': None,
        ...
        #                     'defaultValue': None,
        #                 },
        #                 'createdAt': '2023-05-05T17:17:10.229Z',
        #                 'updatedAt': '2023-05-05T17:19:10.229Z',
        #                 'visibility': None,
        #                 'productInfo': {
        #                     'externalProductIDType': None,
        #                     'externalProductIDValue': None,
        ...
        #             # 'validate': {
        #             #     'entityType': 'item',
        #             #     'entityUUID': '38509254-263f-41bc-97eb-025266afe30b',
        #             # },
        #             'menuType': 'MENU_TYPE_FULFILLMENT_DELIVERY',
        #             'parentObjectUUIDs': [
        #                 f'{Category_ids}',
        ...
        #     cookies=cookies,
        #     headers=headers,
        #     json=set_category_json_data,
        #
        # )
        # print('---UPDATED------------------------------------------------------')
        # print(update_response.status_code)
        # print(item_name)
        # x = json.loads(update_response.text)
        # print(x['status'])
